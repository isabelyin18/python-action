...
# In[5]:
#'airline','http://www.airlinequality.com/forum'
...
class AirlineReviewCollector(SkyThoughtCollector):
    ...
    def parseSoupHeader(self,header):
        ...
        for j in range(len(words)-1):
                ...
                if ")" in words[-1]:
                    ...
                    contry=words[-2].split('(')[1]+country
    ...
    def parseSoupTable(self,table):
        ...
        entertainment=str(images[5]).split("SCORE_")[1].split(".gif")[0]                                                   
            ...
            for al in AirlineReviewCollector.airlines:
                    ...
                    while count < AirlineReviewCollector.limit:
                        ...
                        SoupHeader(review_headers[i])
                                ...
                                blog=str(blogs[i]).split(">")[1].split("<")[0] args=[al,name,surname,year,month,date,country,stat,over_all,money_value,seat_comfort,
            ...
            def collecThoughts(self):
                    ...
                    for link in links:
                        ...
                        for table in tables:
                            ...
                            datee=soup.findAll("meta",{"itemprop":"datePublished"})[0]["content"] args=[date,author,str(parking),str(ambience),str(range),str(economy),str(product),comment]
